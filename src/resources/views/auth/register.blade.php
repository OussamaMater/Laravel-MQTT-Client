                        ...
                        <form action="{{ route('register') }}" class="mt-4" method="POST">
                            ...
                            <div class="form-group mb-4">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" @class(['form-control', 'is-invalid' => $errors->has('name')]) placeholder="John Doe" id="name"
                                        name="name" autofocus>
                                    @error('name')
                            ...
                            <div class="form-group mb-4">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="email" @class(['form-control', 'is-invalid' => $errors->has('email')]) placeholder="example@company.com"
                            ...
                            <div class="form-group">
                                ...
                                <div class="form-group mb-4">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="password" placeholder="Password" @class(['form-control', 'is-invalid' => $errors->has('password')])
